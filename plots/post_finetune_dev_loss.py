...
ducttape = subprocess.Popen(["ducttape", "main.tape", "-C", "main.tconf", "-p", "glue", "summary", "post_finetune_dev_loss"], stdout=subprocess.PIPE)
...
axes.set_title(f"BERT Post-Finetune Dev Loss")
axes.legend()
